...
{
    //-------------------------------------------------------------------------
    public class Warp : TeleportMarkerBase
    {
        ...
        private Transform transformRelative;
        ...
        void Start()
        {
            ...
            transformRelative.position = GameManager.s_Singleton.tpRelativePoint.position;
        }
        ...
        public void GetRelevantComponents()
        {
            ...
            transformRelative = transform.Find("teleport_relative");
        ...
        public void RelativeTp()
        {
            transformRelative.position = player.transform.position;
            GameManager.s_Singleton.TpRelativePoint(transformRelative);
        }
    }
